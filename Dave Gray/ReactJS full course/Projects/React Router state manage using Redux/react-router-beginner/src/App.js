...
/*  The main [App] component to represent the main home page of the app :     
  ...
  // A]  [Importing section]   :   
    // 1- Importing the reqiured public hooks :
    import { useEffect } from 'react';
      
    // 2- importing the required classes and hooks for the routering  : 
    import { Route, Switch } from 'react-router-dom';

    // 3- Importing the required defined custom hooks :
    import useAxiosFetch from './hooks/useAxiosFetch';
    import useWindowSize from './hooks/useWindowSize';


    // 4- Importing the main Fixed components : 
    import Header from './Header';
    import Nav from './Nav';
    import Footer from './Footer';


    // 5- Importing the inner components Routers pages  : 
    ...
    // 6- Importing the required class from the [easy-peasy] library to be used to pull some of the inner defined states :
...
function App() {
  ...
  // 3- Define a variable of detructured object of {width} to be used and called  passed prop to the {width} :
  const { width } = useWindowSize();


  // 4- [First crud operation] : {Fetching data} using custom hook {useAxiosFetch} fetching method (will be used )  =>
  useEffect(() => {
    setPosts(data)
  }, [data, setPosts])
  // -----------------------------------------------
