...
// Define the main and {api routes CRUD} opts pattern on this server  [using  external source of defiend method of each crud of the  {employeesController} ]  =>  [ by assing each one inside it's related method   ]:
