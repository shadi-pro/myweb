...
// 1]  importings the defind array  of the [allowedOrigins]  to be used within  middleware definition   :  
...
const credentials = (res ,req ,next )  => {
  ...
  // Setting the [Access-control-allow-credentials] with true if the allowed origins include the requested origin :  
