...
//  This file will Include  :
  // a- Main [Data model] object   (simulated scripts of js untill we use the real database ) , including the next (2) properties   => 
  ...
  // b- Each Route's main inner CRUD operation  defintions of  custom handling methods of each route  (2 Routes) , as following   => 
    // First route [main static route {'/'} ]  , with  next CRUD opts :
      // 1-  [get operation] 
      // 2-  [create new operation] 
      // 3-  [put/update operation] 
      // 4-  [delete operation]  

    // Second route [dynamic route ('/:id' ]  , with next handling  methods :
